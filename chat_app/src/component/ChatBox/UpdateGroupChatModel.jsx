...
function UpdateGroupChatModel({ fetchAgain, setFetchAgain, fetchMessages }) {
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://chat-app-qxlf.onrender.com/api/chat/groupremove`,
        {
  ...
  const handleAddUser = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://chat-app-qxlf.onrender.com/api/chat/groupadd`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://chat-app-qxlf.onrender.com/api/chat/rename`,
        {
          chatId: selectedChat._id,
          ...
          <ModalBody>
            ...
            <form action="" className="flex">
              <input
                ...
                className="mb-3 p-2 bg-slate-200 rounded-md"
                value={groupChatName}
            ...
            <form action="">
              <input
                ...
                className="mb-1 bg-slate-200 p-2 w-[70%] rounded-md"
